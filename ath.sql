...
CREATE TABLE "ExerciseInPost" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "ExerciseId" integer NOT NULL,
    "PostId" integer NOT NULL,
    CONSTRAINT "PK_ExerciseInPost" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_ExerciseInPost_Exercises_ExerciseId" FOREIGN KEY ("ExerciseId") REFERENCES "Exercises" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_ExerciseInPost_Posts_PostId" FOREIGN KEY ("PostId") REFERENCES "Posts" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "Sets" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "PracticalExerciseId" integer NOT NULL,
    ...
    CONSTRAINT "FK_Sets_PracticalExercises_PracticalExerciseId" FOREIGN KEY ("PracticalExerciseId") REFERENCES "PracticalExercises" ("Id") ON DELETE CASCADE
);
...
CREATE UNIQUE INDEX "IX_ExerciseInPost_ExerciseId_PostId" ON "ExerciseInPost" ("ExerciseId", "PostId");

CREATE INDEX "IX_ExerciseInPost_PostId" ON "ExerciseInPost" ("PostId");
